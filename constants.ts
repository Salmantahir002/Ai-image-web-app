...
export const SUGGESTED_PROMPTS = [
  ...
  "Change the background to a professional studio grey",
...
// Simple SVG Icons as constants using React.createElement to avoid dependency issues and .ts errors
export const ICONS = {
